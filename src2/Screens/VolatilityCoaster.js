...
import VolatilityComponent from '../components/VolatilityComponent';
...
class VolatilityCoaster extends Component {
    constructor(props) {
        super(props),
            this.state = {
                oneHour: false,
                ...
                favourite: false,
                momentumData: [
                    { "id": "1", name: "USDT", coinImage: 1, icon: bitcoin, volumeCharge:"2,465", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "2", name: "USDT", coinImage: 2, icon: ethereum,volumeCharge:"1,206", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "3", name: "USDT", coinImage: 3, icon: ethereum,volumeCharge:"720", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "4", name: "USDT",coinImage: 4, icon: bitcoin,volumeCharge:"7,225", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "5", name: "USDT",coinImage: 5, icon: ethereum,volumeCharge:"80.1 ", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "6", name: "USDT", coinImage: 6,icon: ethereum,volumeCharge:"20.1", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "7", name: "USDT", coinImage: 7,icon: bitcoin,volumeCharge:"4.0.1",dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "8", name: "USDT", coinImage: 8,icon: ethereum,volumeCharge:"20.1", dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                    { "id": "9", name: "USDT", coinImage: 9,icon: ethereum, volumeCharge:"20.1",dropdownImage: increase, average: "+23.89%", price: "$7,8665.41", graph: unselected, imagegraph: selected },
                ]
            }
    }
    searchFunction = () => {
            ...
            <View style={styles.container}>
                <View style={styles.blockContent}>
                    <View style={{ width: 245, padding: 12, }}>
                        <Text style={styles.obvletter}>Volatility</Text>
                        <Text style={styles.obvletter}>Coaster</Text>
                       
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 7, }}>
                            <View style={{ height: 30, width: 30, borderRadius: 30 / 2, marginTop: 22, backgroundColor: '#47DFFF', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View>
                    <Text style={{ fontWeight: 'bold', fontSize: 16, color: '#fff' ,marginVertical:5}}>Volatility Coaster</Text>
				...
				<FlatList
						...
						renderItem={(itemData,key)=>
							<VolatilityComponent itemData={itemData} />
						}
						/>
...
export default VolatilityCoaster;
