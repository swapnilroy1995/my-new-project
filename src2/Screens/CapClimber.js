...
class CapClimber extends Component{
    constructor(props) {
        super(props),
            this.state = {
                oneHour: false,
        ...
        return (
            <View style={styles.container}>
                {/* <Header isBack={true} headerTitle={explorer} /> */}
                    ...
                    <View style={styles.blockContent}>
                        <View style={{ width: 235,padding:12,}}>
                            <Text style={styles.obvletter}>CapClimber</Text>
                ...
                <View style={{ marginVertical:10}}>
                    <Text style={{ fontWeight: 'bold', fontSize: 16, color: '#fff' }}>Cap Climber</Text>
