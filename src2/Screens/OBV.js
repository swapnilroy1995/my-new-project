...
class OBVscreen extends Component{
    constructor(props) {
        super(props),
            this.state = {
                oneHour: false,
                ...
                oneWeek: false,
                recentCoinData: [
                    { "id": "1", name: "USDT", icon: bitcoin, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "2",name: "USDT", icon: ethereum, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "3", name: "USDT", icon: ethereum, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "4", name: "USDT", icon: bitcoin, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "5", name: "USDT",icon: ethereum, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "6", name: "USDT", icon: ethereum, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "7", name: "USDT", icon: bitcoin, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "8", name: "USDT", icon: ethereum, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                    { "id": "9",name: "USDT", icon: ethereum, uptrend: "Uptrend", average: "OBV > Moving Average", price: "$7866541", graph: selectedgraph },
                ]
            }
    }
    searchFunction = () => {
            ...
            <View style={styles.container}>
                {/* <Header isBack={true} headerTitle={explorer} /> */}
                    ...
                    <View style={styles.blockContent}>
                        <View style={{ width: 235,padding:12,}}>
                            <Text style={styles.obvletter}>OBV</Text>
                            <Text style={styles.blockletter}>(On Balance </Text>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 7, }}>
                                ...
                                <Image source={obv} style={styles.gainersImage} resizeMode='contain' />
                            </View>
                        </View>
                    </View>
                ...
                <View style={{ flexDirection: 'row', padding: 10, justifyContent: 'space-between', alignItems: 'center' }}>
                    <Text style={styles.candlestick}>Candlestick Del:</Text>
                    <Text style={styles.filterSelected}>1D</Text>
                    <Text style={styles.candlestick}>SMA Term:</Text>
                    <Text style={styles.filterSelected}>60D</Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }}>
                    ...
                    <Text style={styles.rank}>DEMA Signal</Text>
