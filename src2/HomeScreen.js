...
import { Text, View, StyleSheet, ScrollView, SafeAreaView, FlatList,Modal, TextInput,StatusBar, Dimensions, Platform, TouchableNativeFeedback, TouchableOpacity, Image } from 'react-native'
				...
				<FlatList
					...
					>
                                        ...
                                        <View style={{ flexDirection: 'row',justifyContent: 'space-around', flex: 1}}>
                                            ...
                                            <View>
                                                <Image source={sideBarCircle} style={{flex:1, }} resizeMode='contain' />
                                            </View>
                                        </View>
                                </TouchableOpacity>
						}
